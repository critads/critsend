...
- **Modular Route Architecture:** Routes split into domain-focused modules under `server/routes/` (subscribers, segments, mtas, tracking, webhooks, analytics, ab-testing, warmup, automation, advanced-analytics) with shared helpers. Campaign, import/export, and background workers remain in main `routes.ts`.
