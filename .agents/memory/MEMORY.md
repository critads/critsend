...
- [Smart segment AI guardrails](smart-segment-ai-guardrails.md) — inclusions only via block macros; recount × worst cohort; MTA-aware complaint calibration+floor; nested proposals attach one; evidence cache in JSON.
