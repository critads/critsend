...
export async function getCampaignsPaginated(opts: {
  ...
  const enriched = rows.map((row) => {
    ...
    return {
      ...
      orangeWanadooSentCount,
      orangeWanadooComplaintsCount,
      orangeWanadooComplaintRate: orangeWanadooSentCount > 0
        ? orangeWanadooComplaintsCount / orangeWanadooSentCount
        : null,
